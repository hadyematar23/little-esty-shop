...
RSpec.describe Merchant, type: :model do
  describe 'relationships' do 
    ...
    before(:each) do
      ...
      @invoice1 = Invoice.create!(customer: @customer1, status: 1) 
      @invoice2 = Invoice.create!(customer: @customer1, status: 1) 
      @invoice3 = Invoice.create!(customer: @customer1, status: 1) 
      @invoice4 = Invoice.create!(customer: @customer1, status: 1) 
      ...
      @invoice5 = Invoice.create!(customer: @customer2, status: 1) 
      @invoice6 = Invoice.create!(customer: @customer2, status: 1) 
      @invoice7 = Invoice.create!(customer: @customer2, status: 1) 
      ...
      @invoice8 = Invoice.create!(customer: @customer3, status: 1) 
      @invoice9 = Invoice.create!(customer: @customer3, status: 1) 
      ...
      @invoice10 = Invoice.create!(customer: @customer4, status: 1) 
      @invoice11 = Invoice.create!(customer: @customer4, status: 1) 
      ...
      @invoice12 = Invoice.create!(customer: @customer5, status: 1) 
      @invoice13 = Invoice.create!(customer: @customer5, status: 1) 
      ...
      @invoice14 = Invoice.create!(customer: @customer6, status: 1) 
      @invoice15 = Invoice.create!(customer: @customer6, status: 1) 
      @invoice16 = Invoice.create!(customer: @customer6, status: 1) 
    ...
    describe "user stories 4 and 5" do
      before do
        ...
        @invoice17 = Invoice.create!(customer: @deniz, created_at: 1.days.ago, updated_at: 1.days.ago, status: 0)
        @invoice18 = Invoice.create!(customer: @deniz, created_at: 1.days.ago, updated_at: 1.days.ago, status: 0)
        @invoice19 = Invoice.create!(customer: @deniz, created_at: 4.days.ago, updated_at: 4.days.ago, status: 0)
        @ii1 = InvoiceItem.create!(item: @item4, invoice: @invoice17, quantity: 1, unit_price: 1950, status: 0)
        @ii2 = InvoiceItem.create!(item: @item5, invoice: @invoice18, quantity: 1, unit_price: 2850, status: 2)
        @ii3 = InvoiceItem.create!(item: @item6, invoice: @invoice19, quantity: 1, unit_price: 1650, status: 1)
        ...
        @invoice20  = Invoice.create!(customer: @emre, created_at: 3.days.ago, updated_at: 3.days.ago, status: 0)
        @ii4 = InvoiceItem.create!(item: @item4, invoice: @invoice20, quantity: 1, unit_price: 9950, status: 1)
        @ii5 = InvoiceItem.create!(item: @item5, invoice: @invoice20, quantity: 1, unit_price: 1000, status: 2)
        ...
        @invoice21  = Invoice.create!(customer: @serap, created_at: 2.days.ago, updated_at: 2.days.ago, status: 0)
        @ii6 = InvoiceItem.create!(item: @item4, invoice: @invoice21, quantity: 1, unit_price: 9950, status: 1)
        @ii7 = InvoiceItem.create!(item: @item5, invoice: @invoice21, quantity: 1, unit_price: 1000, status: 1)
        @invoice6.transactions.create!(credit_card_number: "4654405418249638", credit_card_expiration_date: "08/29", result: 0)
      end
    ...
    describe '#top_five merchants based on total revenue' do
      before(:each) do
        ...
        @invoice1 = Invoice.create!(customer: @customer1, status: 1, created_at: "01/01/2023".to_date) 
        @invoice2 = Invoice.create!(customer: @customer1, status: 1, created_at: "02/02/2023".to_date)
        @invoice3 = Invoice.create!(customer: @customer1, status: 1, created_at: "10/02/2022".to_date)
        @invoice4 = Invoice.create!(customer: @customer1, status: 1)
        @invoice5 = Invoice.create!(customer: @customer1, status: 1)
        @invoice6 = Invoice.create!(customer: @customer1, status: 1)
        @invoice7 = Invoice.create!(customer: @customer1, status: 1)
        ...
        @transaction1 = @invoice1.transactions.create!(credit_card_number: "4654405418249636", credit_card_expiration_date: "06/29", result: 0)
        @transaction2 = @invoice1.transactions.create!(credit_card_number: "4654405418249636", credit_card_expiration_date: "06/29", result: 0)
        @transaction3 = @invoice2.transactions.create!(credit_card_number: "4654405418249636", credit_card_expiration_date: "06/29", result: 0)
        @transaction4 = @invoice2.transactions.create!(credit_card_number: "4654405418249636", credit_card_expiration_date: "06/29", result: 0)
        @transaction5 = @invoice3.transactions.create!(credit_card_number: "4654405418249636", credit_card_expiration_date: "06/29", result: 0)
        @transaction6 = @invoice4.transactions.create!(credit_card_number: "4654405418249636", credit_card_expiration_date: "06/29", result: 0)
        @transaction7 = @invoice5.transactions.create!(credit_card_number: "4654405418249636", credit_card_expiration_date: "06/29", result: 0)
      end
